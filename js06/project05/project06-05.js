...
function calcCart() {
   ...
   if (selectedSession !== -1) {
      sessionChoice = document.forms.register.elements.sessionOption[selectedSession].text;
      sessionCost = document.forms.register.elements.sessionOption[selectedSession].value;
   }
   ...
   document.getElementById("regTotal").textContent = totalCost.toLocaleString("en-US", {
      style: "currency",
      currency: "USD"
   });
}